import { SET_DANH_SACH_PHIM, SET_FILM_SAP_CHIEU,SET_FILM_DANG_CHIEU, SET_THONG_TIN_PHIM } from "../typeAction/QuanLyPhimType"
import { SET_CHI_TIET_PHIM } from "../typeAction/QuanLyRapType";
const stateDefault = {
    arrFilm: [
        {
          "maPhim": 1282,
