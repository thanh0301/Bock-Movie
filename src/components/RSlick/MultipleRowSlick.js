...
import {SET_FILM_DANG_CHIEU,SET_FILM_SAP_CHIEU} from '../../redux/typeAction/QuanLyPhimType'
...
const MultipleRowSlick = (props) => {
  ...
  const {dangChieu,sapChieu,arrFilm} = useSelector(state => state.QuanLyPhimReducer);
